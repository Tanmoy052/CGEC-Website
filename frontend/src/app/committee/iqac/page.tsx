...
export default function IQACPage() {
  ...
  useEffect(() => {
    fetch(`${API_URL}/public/committees?committee=iqac`)
    ...
    <div className="min-h-screen bg-white pb-12">
      ...
      <div className="container mx-auto px-4 max-w-6xl">
        ...
        <p className="text-gray-700 mb-8 leading-relaxed">
          The Internal Quality Assurance Cell ensures continuous improvement
          in academic and administrative performance across the institution.
        </p>
